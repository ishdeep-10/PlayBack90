...
The setup script installs Firefox ESR, pinned geckodriver 0.37.1, a dedicated Python virtual environment, a locked-down `playback90` system user, 2 GiB swap, and the systemd unit. It intentionally does not start the worker before secrets are configured.
