...
export function PassNetworkPlotly({
  ...
  const traces = useMemo(() => {
    ...
    const heatTrace = {
      ...
      colorscale: [
        [0, "rgba(0,0,0,0)"],
        [0.35, colorWithAlpha(teamColor, themeColors.mode === "dark" ? 0.16 : 0.12)],
        [0.72, colorWithAlpha(teamColor, themeColors.mode === "dark" ? 0.36 : 0.28)],
        [1, colorWithAlpha(teamColor, themeColors.mode === "dark" ? 0.66 : 0.5)],
      ],
